...
<MantraHeader />
        ...
        <div className="flex justify-center mb-10">
            <div className="bg-red-800 dark:bg-red-900 text-white px-10 py-2 rounded-full font-bold text-2xl shadow-md border-2 border-red-900 dark:border-red-200">
                वैवाहिक कार्यक्रम
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          ...
          {/* Tile 2 */}
          <div className="border-2 border-red-200 dark:border-red-900 rounded-3xl p-4 text-center bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
            <h3 className="text-2xl font-extrabold mb-1">मण्डपाच्छादन हल्दी कलश</h3>
        ...
        {/* <div className="text-center mb-8">
            <p className="text-2xl font-extrabold text-red-800 dark:text-red-200">
                विवाह स्थल- रजवरिया।
            </p>
        </div> */}
        ...
        {/* Bottom Poetry Box */}
        <div className="text-red-900 dark:text-white p-4 rounded-b-3xl text-center font-bold italic border-2 border-red-200 bg-white/50 dark:bg-slate-800/50">
          "कौन किसके करीब होता है, कौन किसका नसीब होता है,<br/>
