...
const TravelDetails: React.FC = () => {
  ...
  const travelHubs = [
    ...
    { 
      name: "Gaya Junction (GAYA) / Airport (GAY)", 
    ...
    { 
      name: "Patna Junction (PNBE) / Airport (PAT)", 
      type: "Capital Hub", 
      dist: "140 KM",
      trains: [
            ...
            <div key={i} className="flex flex-col bg-slate-50/50 dark:bg-slate-900/30 rounded-2xl border border-red-50 dark:border-slate-800 overflow-hidden transition-all duration-300">
              ...
              <div className="flex items-start justify-between p-4 gap-3">
                ...
                <div className="flex flex-col min-w-0 flex-1">
                  ...
                  {/* Name + Button Group: Uses flex-wrap for long names */}
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-sm md:text-base font-bold text-red-900 dark:text-red-100 leading-tight">
                      {hub.name}
                    </span>
                ...
                {/* Right Side: Badge - flex-shrink-0 is CRITICAL here */}
                <div className="flex-shrink-0 pt-1">
                  <span className="text-[10px] md:text-sm font-black text-white bg-red-800 dark:bg-red-900 px-3 py-1.5 rounded-full shadow-sm whitespace-nowrap min-w-[65px] inline-block text-center">
                    {hub.dist}
                  </span>
                </div>
              </div>
